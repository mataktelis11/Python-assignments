...
while True:
    try:
        ...
        if(text==""):
            ...
            print("--->Print file demofile.txt")
            print("")
            print(text)
            print("--->Split the words with the spaces to turn it into a list")
            print("")
            ...
            print("--->Start loop to go over all elements of the list")
            print("--->Check if they are words and do the algorithm")
